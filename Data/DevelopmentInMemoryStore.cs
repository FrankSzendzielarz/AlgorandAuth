...
namespace AlgorandAuth.Data
{
    public class DevelopmentInMemoryStore
    {
        ...
        internal AlgorandStoredCredential? GetCredentialByAlgorandId(byte[] id)
        {
            return _storedCredentials.FirstOrDefault(c => (c as AlgorandStoredCredential).AlgorandCredentialId.Id.AsSpan().SequenceEqual(id)) as AlgorandStoredCredential;
        }
    }
}
